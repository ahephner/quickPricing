...
async advancedSearch() {
    ...
    try {
        ...
        //let pricing = reNameKey([...data.pricing], 'Floor_Price__c','flrPrice'); 
        ...
        this.prod = await final.map((item, index) => ({
            ...
            RUP: item.Product__r.Restricted_States__c != undefined ? true:false,
            rupStates: item.Product__r.Restricted_States__c != undefined ? item.Product__r.Restricted_States__c : '',
            links : item.Product__r.Restricted_States__c != undefined ? 'warnLink': 'searchLinks'
        }));
